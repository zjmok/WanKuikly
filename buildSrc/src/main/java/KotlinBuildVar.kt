...
//    const val KUIKLY_VERSION = "2.5.0"

    const val KOTLIN_VERSION = "2.0.21"

    // shared/build.ohos.gradle.kts 项目依赖使用的版本
    const val KOTLIN_OHOS_VERSION = "2.0.21-ohos"

    // build.ohos.gradle.kts 插件依赖使用的版本
    const val PLUGIN_KOTLIN_OHOS_VERSION = "2.0.21-KBA-010"
